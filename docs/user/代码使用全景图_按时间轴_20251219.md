# 🗺️ Heablcoin 代码使用全景图（按时间轴）

> 📅 生成时间：2025-12-19  
> 🔖 分支/版本：`heablcoin_v2` @ `2749c3d`  
> 🎯 目的：让新成员/操作者按“时间轴”快速定位该用哪些脚本、输入输出什么数据、以及数据如何流转。

> ✅ 最新版本（不带时间戳，作为长期维护入口）：`docs/user/代码使用全景图_按时间轴.md`  
> ⚠️ 本文件保留为历史快照，内容后续不保证持续更新。
