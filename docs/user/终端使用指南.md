...
```python
from skills.personal_analytics import PersonalAnalyzer
...
- [MCP 使用指南](MCP使用指南.md) - 在 Claude Desktop/Windsurf 中使用
- [API 参考文档](../developer/API参考.md) - MCP Tools 清单与约定
- [故障排查指南](故障排查.md) - 常见问题定位与解决
- [文档索引](README.md) - 用户文档入口
