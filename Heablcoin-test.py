############################################################
# 📘 文件说明：终端综合测试入口
# 本文件实现的功能：无需MCP客户端即可对Heablcoin核心能力进行一键自检
#
# 📋 程序整体伪代码（中文）：
# 1. 初始化依赖模块和配置
# 2. 定义核心类和函数
...
#
# 🧩 文件结构：
# - 函数: print_header, print_section, test_connection, test_system_status, test_market_analysis
#
# 🔗 主要依赖：Heablcoin, argparse, os, pandas, sys
#
# 🕒 创建时间：2025-12-18
############################################################
