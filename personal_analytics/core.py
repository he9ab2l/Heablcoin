...
# 🧩 文件结构：
# - 类: PersonalAnalyzer
# - 函数: analyze, list_modules
#
# 🔗 主要依赖：__future__, json, personal_analytics, typing
#
# 🕒 创建时间：2025-12-18
############################################################
...
from personal_analytics.data_provider import read_trade_history
...
from personal_analytics.modules.trade_journal import analyze_journal
from personal_analytics.modules.funds_flow import analyze_funds
...
class PersonalAnalyzer:
    ...
    def list_modules(cls) -> List[Dict[str, str]]:
        """列出所有可用模块"""
        from personal_analytics.modules.performance import get_module_info as perf_info
        from personal_analytics.modules.risk import get_module_info as risk_info
        from personal_analytics.modules.attribution import get_module_info as attr_info
        from personal_analytics.modules.trading_behavior import get_module_info as behav_info
        from personal_analytics.modules.portfolio import get_module_info as port_info
        from personal_analytics.modules.cost_analysis import get_module_info as cost_info
        from personal_analytics.modules.period_stats import get_module_info as period_info
        from personal_analytics.modules.session_analysis import get_module_info as sess_info
        from personal_analytics.modules.trade_journal import get_module_info as journal_info
        from personal_analytics.modules.funds_flow import get_module_info as funds_info
