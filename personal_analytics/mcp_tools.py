...
#
# 🧩 文件结构：
# - 函数: register_tools, get_personal_analysis, get_full_personal_analysis, get_portfolio_analysis, get_period_performance
#
# 🔗 主要依赖：__future__, personal_analytics, report, typing
#
# 🕒 创建时间：2025-12-18
############################################################
...
from personal_analytics.core import PersonalAnalyzer
from personal_analytics.modules.trade_journal import add_trade_note, search_trades
from personal_analytics.modules.funds_flow import add_funds_record
