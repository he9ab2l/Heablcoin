...
#
# 🧩 文件结构：
# - 函数: register_tools, get_learning_catalog, start_learning_session, submit_learning_answer, get_learning_history
#
# 🔗 主要依赖：__future__, json, learning, orchestration, report, typing, utils
#
# 🕒 创建时间：2025-12-18
############################################################
...
from learning.storage import list_sessions, load_session, create_session
from learning.discipline import load_rules, save_rules, is_locked_now
...
from learning.notifier import send_learning_report, send_training_summary
...
def register_tools(mcp: Any) -> None:
    ...
    def start_blind_history_test(
        ...
        # 保存答案到会话
        from learning.storage import create_session
