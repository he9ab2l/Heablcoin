...
#
# 🧩 文件结构：
# - 函数: test_mcp_tool_safe_decorator, test_stdout_isolation, test_env_helpers, test_notification_switches, test_safe_filename
#
# 🔗 主要依赖：functools, io, os, re, sys, traceback, typing
#
# 🕒 创建时间：2025-12-18
############################################################
