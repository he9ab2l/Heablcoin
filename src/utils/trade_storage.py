...
# 🧩 文件结构：
# - 类: TradeStore
# - 函数: insert_trade, list_trades, iter_trades, sum_cost_by_date_prefix, stats_since_date_prefix
#
# 🔗 主要依赖：contextlib, csv, datetime, os, pathlib, sqlite3, threading, typing
#
# 🕒 创建时间：2025-12-18
############################################################
