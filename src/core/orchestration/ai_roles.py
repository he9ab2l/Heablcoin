...
#
# 🧩 文件结构：
# - 类: AIRole, RoleConfig, AIResponse
# - 函数: get_role_config, call_ai, call_ai_async, reason, write
#
# 🔗 主要依赖：__future__, cloud, dataclasses, enum, json, orchestration, time, typing
#
# 🕒 创建时间：2025-12-18
############################################################
