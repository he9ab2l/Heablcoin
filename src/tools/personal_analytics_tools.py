...
# - 依赖（第三方）：无
# - 依赖（本地）：core.mcp_safety, skills.personal_analytics.core, skills.personal_analytics.data_provider, skills.personal_analytics.modules.funds_flow, skills.personal_analytics.modules.trade_journal, skills.report.query_backup
#
# 🕒 创建时间：2025-12-19
############################################################
