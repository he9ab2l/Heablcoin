...
# - 依赖（第三方）：无
# - 依赖（本地）：.data_provider, .modules.attribution, .modules.cost_analysis, .modules.funds_flow, .modules.performance, .modules.period_stats, .modules.portfolio, .modules.risk, .modules.session_analysis, .modules.trade_journal, .modules.trading_behavior
#
# 🕒 创建时间：2025-12-19
############################################################
