...
# - 函数: get_fundamental_analyzer, analyze_news, analyze_on_chain, get_market_events, comprehensive_fundamental_analysis
#
# 🔗 主要依赖：__future__, datetime, json, orchestration, typing, utils
#
# 🕒 创建时间：2025-12-18
############################################################
...
from orchestration.ai_roles import research, call_ai, AIRole
